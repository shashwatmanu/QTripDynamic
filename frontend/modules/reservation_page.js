...
if(reservations&&reservations.length){
  ...
  reservations.forEach(res =>{
    ...
    <td><button type="button" id="${res.id}" class="reservation-visit-button"><a href="/frontend/pages/adventures/detail/?adventure=${res.adventure}">Visit Adventure</a></button></td>`
